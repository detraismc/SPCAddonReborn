...
public class Artificial_Crops_Coal extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Artificial_Crops_Coal() {
	        super(SPCItems.category_plant, SPCItems.ARTIFICIAL_CROPS_COAL, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	        		SlimefunItem.getById("COAL_PLANT").getItem(), SPCItems.ARTIFICIAL_HARVESTER, SlimefunItem.getById("COAL_PLANT").getItem(),
	   ...
	   protected void registerDefaultRecipes() {
	      this.registerRecipe(12, new ItemStack[]{new ItemStack(Material.BONE_MEAL, 3)}, new ItemStack[]{SlimefunItem.getById("COAL_ESSENCE").getItem()});
	      ...
	      for (ItemStack itemlah : fertilizer) {
	    	  this.registerRecipe(12, new ItemStack[]{itemlah}, new ItemStack[]{SlimefunItem.getById("COAL_ESSENCE").getItem()});
	      }
	      
	      this.recipeList = new ArrayList<ItemStack>();
	      this.recipeList.add(new ItemStack(Material.BONE_MEAL, 3));
	      this.recipeList.add(SlimefunItem.getById("COAL_ESSENCE").getItem());
	   ...
	   @Override
	    ...
	    public String getInventoryTitle() {
	        return "&aArtificial Crops &e[Coal]";
	    }
