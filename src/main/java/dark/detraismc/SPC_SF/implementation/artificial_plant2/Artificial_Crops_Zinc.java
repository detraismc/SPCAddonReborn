...
public class Artificial_Crops_Zinc extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Artificial_Crops_Zinc() {
	        super(SPCItems.category_plant, SPCItems.ARTIFICIAL_CROPS_ZINC, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	        		SPCItems.ZINC_ARTIFICIAL_SEEDS, SPCItems.ARTIFICIAL_HARVESTER, SPCItems.ZINC_ARTIFICIAL_SEEDS,
	   ...
	   @Override
	    ...
	    public String getInventoryTitle() {
	        return "&aArtificial Crops &e[Zinc]";
	    }
