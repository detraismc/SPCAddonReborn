...
public class Artificial_Crops_Gold_3 extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Artificial_Crops_Gold_3() {
	        super(SPCItems.category_plant, SPCItems.ARTIFICIAL_CROPS_GOLD_3, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	        		SPCItems.BIFURCATING_COMPONENT, SPCItems.ENDERITE_PLATE, SPCItems.BIFURCATING_COMPONENT,
	        		SPCItems.PROFESSIONAL_CIRCUIT_BOARD, SPCItems.ARTIFICIAL_CROPS_GOLD_2, SPCItems.PROFESSIONAL_CIRCUIT_BOARD,
	        		SPCItems.BIFURCATING_COMPONENT, SPCItems.CROPS_MOTOR, SPCItems.BIFURCATING_COMPONENT
		    });
	    }

	   protected void registerDefaultRecipes() {
	      this.registerRecipe(12, new ItemStack[]{new ItemStack(Material.BONE_MEAL, 3)}, new ItemStack[]{SlimefunItems.GOLD_DUST});
	      ...
	      for (ItemStack itemlah : fertilizer) {
	    	  this.registerRecipe(12, new ItemStack[]{itemlah}, new ItemStack[]{SlimefunItems.GOLD_DUST});
	      }
	      
	      this.recipeList = new ArrayList<ItemStack>();
	      this.recipeList.add(new ItemStack(Material.BONE_MEAL, 3));
	      this.recipeList.add(SlimefunItems.GOLD_DUST);
	   ...
	   public String getMachineIdentifier() {
	      return "ARTIFICIAL_CROPS_GOLD_3";
	   }
	   ...
	   @Override
	    ...
	    public String getInventoryTitle() {
	        return "&aArtificial Crops &e[Gold] &7- &eIII";
	    }
