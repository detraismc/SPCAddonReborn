...
public class Artificial_Crops_Aluminum extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Artificial_Crops_Aluminum() {
	        super(SPCItems.category_plant, SPCItems.ARTIFICIAL_CROPS_ALUMINUM, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	        		SlimefunItem.getById("ALUMINUM_PLANT").getItem(), SPCItems.ARTIFICIAL_HARVESTER, SlimefunItem.getById("ALUMINUM_PLANT").getItem(),
	   ...
	   protected void registerDefaultRecipes() {
	      this.registerRecipe(12, new ItemStack[]{new ItemStack(Material.BONE_MEAL, 3)}, new ItemStack[]{SlimefunItem.getById("ALUMINUM_ESSENCE").getItem()});
	      ...
	      for (ItemStack itemlah : fertilizer) {
	    	  this.registerRecipe(12, new ItemStack[]{itemlah}, new ItemStack[]{SlimefunItem.getById("ALUMINUM_ESSENCE").getItem()});
	      }
	      
	      this.recipeList = new ArrayList<ItemStack>();
	      this.recipeList.add(new ItemStack(Material.BONE_MEAL, 3));
	      this.recipeList.add(SlimefunItem.getById("ALUMINUM_ESSENCE").getItem());
	   ...
	   public String getMachineIdentifier() {
	      return "ARTIFICIAL_CROPS_ALUMINUM";
	   }
	   ...
	   @Override
	    ...
	    public String getInventoryTitle() {
	        return "&aArtificial Crops &e[Aluminum]";
	    }
