...
public class Artificial_Crops_Silver extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Artificial_Crops_Silver() {
	        super(SPCItems.category_plant, SPCItems.ARTIFICIAL_CROPS_SILVER, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	        		SlimefunItem.getById("SILVER_PLANT").getItem(), SPCItems.ARTIFICIAL_HARVESTER, SlimefunItem.getById("SILVER_PLANT").getItem(),
	   ...
	   protected void registerDefaultRecipes() {
	      this.registerRecipe(12, new ItemStack[]{new ItemStack(Material.BONE_MEAL, 3)}, new ItemStack[]{SlimefunItem.getById("SILVER_ESSENCE").getItem()});
	      ...
	      for (ItemStack itemlah : fertilizer) {
	    	  this.registerRecipe(12, new ItemStack[]{itemlah}, new ItemStack[]{SlimefunItem.getById("SILVER_ESSENCE").getItem()});
	      }
	      
	      this.recipeList = new ArrayList<ItemStack>();
	      this.recipeList.add(new ItemStack(Material.BONE_MEAL, 3));
	      this.recipeList.add(SlimefunItem.getById("SILVER_ESSENCE").getItem());
	   ...
	   public String getMachineIdentifier() {
	      return "ARTIFICIAL_CROPS_SILVER";
	   }
	   ...
	   @Override
	    ...
	    public String getInventoryTitle() {
	        return "&aArtificial Crops &e[Silver]";
	    }
