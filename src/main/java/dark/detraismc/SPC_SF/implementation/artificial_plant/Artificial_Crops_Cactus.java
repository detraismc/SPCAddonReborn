...
public class Artificial_Crops_Cactus extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Artificial_Crops_Cactus() {
	        super(SPCItems.category_plant, SPCItems.ARTIFICIAL_CROPS_CACTUS, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	        		new ItemStack(Material.CACTUS), SPCItems.ARTIFICIAL_HARVESTER, new ItemStack(Material.CACTUS),
	   ...
	   public String getMachineIdentifier() {
	      return "ARTIFICIAL_CROPS_CACTUS";
	   }
	   ...
	   @Override
	    ...
	    public String getInventoryTitle() {
	        return "&aArtificial Crops &e[Cactus]";
	    }
