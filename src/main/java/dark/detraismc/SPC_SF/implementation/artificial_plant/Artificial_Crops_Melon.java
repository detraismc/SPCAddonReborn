...
public class Artificial_Crops_Melon extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Artificial_Crops_Melon() {
	        super(SPCItems.category_plant, SPCItems.ARTIFICIAL_CROPS_MELON, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	        		new ItemStack(Material.MELON_SEEDS), SPCItems.ARTIFICIAL_HARVESTER, new ItemStack(Material.MELON_SEEDS),
	   ...
	   protected void registerDefaultRecipes() {
	      this.registerRecipe(8, new ItemStack[]{new ItemStack(Material.BONE_MEAL, 2)}, new ItemStack[]{new ItemStack(Material.MELON_SLICE, 9)});
	      this.registerRecipe(8, new ItemStack[]{new ItemStack(Material.MELON_SEEDS, 1)}, new ItemStack[]{new ItemStack(Material.MELON_SLICE, 18)});
	      ...
	      for (ItemStack itemlah : fertilizer) {
	    	  this.registerRecipe(8, new ItemStack[]{itemlah}, new ItemStack[]{new ItemStack(Material.MELON, 1)});
	      }
	      
	      this.recipeList = new ArrayList<ItemStack>();
	      this.recipeList.add(new ItemStack(Material.BONE_MEAL, 2));
	      this.recipeList.add(new ItemStack(Material.MELON_SLICE, 9));
	      
	      this.recipeList.add(new ItemStack(Material.MELON_SEEDS));
	      this.recipeList.add(new ItemStack(Material.MELON_SLICE, 18));
	   ...
	   @Override
	    ...
	    public String getInventoryTitle() {
	        return "&aArtificial Crops &e[Melon]";
	    }
