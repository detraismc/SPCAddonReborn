...
public class Artificial_Crops_Sweet_Berries extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Artificial_Crops_Sweet_Berries() {
	        super(SPCItems.category_plant, SPCItems.ARTIFICIAL_CROPS_SWEET_BERRIES, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	        		new ItemStack(Material.SWEET_BERRIES), SPCItems.ARTIFICIAL_HARVESTER, new ItemStack(Material.SWEET_BERRIES),
	   ...
	   protected void registerDefaultRecipes() {
	      this.registerRecipe(8, new ItemStack[]{new ItemStack(Material.BONE_MEAL, 2)}, new ItemStack[]{new ItemStack(Material.SWEET_BERRIES, 2)});
	      ...
	      for (ItemStack itemlah : fertilizer) {
	    	  this.registerRecipe(8, new ItemStack[]{itemlah}, new ItemStack[]{new ItemStack(Material.SWEET_BERRIES, 2)});
	      }
	      
	      this.recipeList = new ArrayList<ItemStack>();
	      this.recipeList.add(new ItemStack(Material.BONE_MEAL, 1));
	      this.recipeList.add(new ItemStack(Material.SWEET_BERRIES, 1));
	      
	      for (ItemStack itemlah : fertilizer) {
	    	  this.recipeList.add(itemlah);
		      this.recipeList.add(new ItemStack(Material.SWEET_BERRIES, 2));
		      }
	   ...
	   public String getMachineIdentifier() {
	      return "ARTIFICIAL_CROPS_SWEET_BERRIES";
	   }
	   ...
	   @Override
	    ...
	    public String getInventoryTitle() {
	        return "&aArtificial Crops &e[Sweet Berries]";
	    }
