...
public class Artificial_Crops_Cocoa_Beans extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Artificial_Crops_Cocoa_Beans() {
	        super(SPCItems.category_plant, SPCItems.ARTIFICIAL_CROPS_COCOA_BEANS, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	        		new ItemStack(Material.COCOA_BEANS), SPCItems.ARTIFICIAL_HARVESTER, new ItemStack(Material.COCOA_BEANS),
	   ...
	   public String getMachineIdentifier() {
	      return "ARTIFICIAL_CROPS_COCOA_BEANS";
	   }
	   ...
	   @Override
	    ...
	    public String getInventoryTitle() {
	        return "&aArtificial Crops &e[Cocoa Beans]";
	    }
