...
public class Artificial_Crops_Wheat extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Artificial_Crops_Wheat() {
	        super(SPCItems.category_plant, SPCItems.ARTIFICIAL_CROPS_WHEAT, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	        		new ItemStack(Material.WHEAT_SEEDS), SPCItems.ARTIFICIAL_HARVESTER, new ItemStack(Material.WHEAT_SEEDS),
	   ...
	   protected void registerDefaultRecipes() {
	      this.registerRecipe(8, new ItemStack[]{new ItemStack(Material.BONE_MEAL, 2)}, new ItemStack[]{new ItemStack(Material.WHEAT, 1)});
	      this.registerRecipe(8, new ItemStack[]{new ItemStack(Material.WHEAT_SEEDS, 1)}, new ItemStack[]{new ItemStack(Material.WHEAT, 2)});
	      ...
	      for (ItemStack itemlah : fertilizer) {
	    	  this.registerRecipe(8, new ItemStack[]{itemlah}, new ItemStack[]{new ItemStack(Material.WHEAT, 1)});
	      }
	      
	      this.recipeList = new ArrayList<ItemStack>();
	      this.recipeList.add(new ItemStack(Material.BONE_MEAL, 2));
	      this.recipeList.add(new ItemStack(Material.WHEAT, 1));
	      
	      this.recipeList.add(new ItemStack(Material.WHEAT_SEEDS));
	      this.recipeList.add(new ItemStack(Material.WHEAT, 2));
	   ...
	   @Override
	    ...
	    public String getInventoryTitle() {
	        return "&aArtificial Crops &e[Wheat]";
	    }
