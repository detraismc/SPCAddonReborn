...
public class Artificial_Crops_Sugar_Cane extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Artificial_Crops_Sugar_Cane() {
	        super(SPCItems.category_plant, SPCItems.ARTIFICIAL_CROPS_SUGAR_CANE, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	        		new ItemStack(Material.SUGAR_CANE), SPCItems.ARTIFICIAL_HARVESTER, new ItemStack(Material.SUGAR_CANE),
	   ...
	   public String getMachineIdentifier() {
	      return "ARTIFICIAL_CROPS_SUGAR_CANE";
	   }
	   ...
	   @Override
	    ...
	    public String getInventoryTitle() {
	        return "&aArtificial Crops &e[Sugar Cane]";
	    }
