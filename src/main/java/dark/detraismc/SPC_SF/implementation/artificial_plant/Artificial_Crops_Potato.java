...
public class Artificial_Crops_Potato extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Artificial_Crops_Potato() {
	        super(SPCItems.category_plant, SPCItems.ARTIFICIAL_CROPS_POTATO, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	        		new ItemStack(Material.POTATO), SPCItems.ARTIFICIAL_HARVESTER, new ItemStack(Material.POTATO),
	   ...
	   public String getMachineIdentifier() {
	      return "ARTIFICIAL_CROPS_POTATO";
	   }
	   ...
	   @Override
	    ...
	    public String getInventoryTitle() {
	        return "&aArtificial Crops &e[Potato]";
	    }
