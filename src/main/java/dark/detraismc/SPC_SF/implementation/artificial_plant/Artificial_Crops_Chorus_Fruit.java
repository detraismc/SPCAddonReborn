...
public class Artificial_Crops_Chorus_Fruit extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Artificial_Crops_Chorus_Fruit() {
	        super(SPCItems.category_plant, SPCItems.ARTIFICIAL_CROPS_CHORUS_FRUIT, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	        		new ItemStack(Material.CHORUS_FLOWER), SPCItems.ARTIFICIAL_HARVESTER, new ItemStack(Material.CHORUS_FLOWER),
	   ...
	   protected void registerDefaultRecipes() {
	      this.registerRecipe(8, new ItemStack[]{new ItemStack(Material.BONE_MEAL, 2)}, new ItemStack[]{new ItemStack(Material.CHORUS_FRUIT, 1)});
	      ...
	      for (ItemStack itemlah : fertilizer) {
	    	  this.registerRecipe(8, new ItemStack[]{itemlah}, new ItemStack[]{new ItemStack(Material.CHORUS_FRUIT, 1)});
	      }
	      
	      this.recipeList = new ArrayList<ItemStack>();
	      this.recipeList.add(new ItemStack(Material.BONE_MEAL, 2));
	      this.recipeList.add(new ItemStack(Material.CHORUS_FRUIT, 1));
	   ...
	   public String getMachineIdentifier() {
	      return "ARTIFICIAL_CROPS_CHORUS_FRUIT";
	   }
	   ...
	   @Override
	    ...
	    public String getInventoryTitle() {
	        return "&aArtificial Crops &e[Chorus Fruit]";
	    }
