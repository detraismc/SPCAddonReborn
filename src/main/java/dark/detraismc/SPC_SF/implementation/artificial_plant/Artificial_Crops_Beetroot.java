...
public class Artificial_Crops_Beetroot extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Artificial_Crops_Beetroot() {
	        super(SPCItems.category_plant, SPCItems.ARTIFICIAL_CROPS_BEETROOT, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	        		new ItemStack(Material.BEETROOT_SEEDS), SPCItems.ARTIFICIAL_HARVESTER, new ItemStack(Material.BEETROOT_SEEDS),
	   ...
	   protected void registerDefaultRecipes() {
	      this.registerRecipe(8, new ItemStack[]{new ItemStack(Material.BONE_MEAL, 2)}, new ItemStack[]{new ItemStack(Material.BEETROOT, 1)});
	      this.registerRecipe(8, new ItemStack[]{new ItemStack(Material.BEETROOT_SEEDS, 1)}, new ItemStack[]{new ItemStack(Material.BEETROOT, 2)});
	      ...
	      for (ItemStack itemlah : fertilizer) {
	    	  this.registerRecipe(8, new ItemStack[]{itemlah}, new ItemStack[]{new ItemStack(Material.BEETROOT, 1)});
	      }
	      
	      this.recipeList = new ArrayList<ItemStack>();
	      this.recipeList.add(new ItemStack(Material.BONE_MEAL, 2));
	      this.recipeList.add(new ItemStack(Material.BEETROOT, 1));
	      
	      this.recipeList.add(new ItemStack(Material.BEETROOT_SEEDS));
	      this.recipeList.add(new ItemStack(Material.BEETROOT, 2));
	   ...
	   public String getMachineIdentifier() {
	      return "ARTIFICIAL_CROPS_BEETROOT";
	   }
	   ...
	   @Override
	    ...
	    public String getInventoryTitle() {
	        return "&aArtificial Crops &e[Beetroot]";
	    }
