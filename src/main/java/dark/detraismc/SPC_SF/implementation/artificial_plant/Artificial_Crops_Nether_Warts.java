...
public class Artificial_Crops_Nether_Warts extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Artificial_Crops_Nether_Warts() {
	        super(SPCItems.category_plant, SPCItems.ARTIFICIAL_CROPS_NETHER_WARTS, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	        		new ItemStack(Material.NETHER_WART), SPCItems.ARTIFICIAL_HARVESTER, new ItemStack(Material.NETHER_WART),
	   ...
	   public String getMachineIdentifier() {
	      return "ARTIFICIAL_CROPS_NETHER_WART";
	   }
	   ...
	   @Override
	    ...
	    public String getInventoryTitle() {
	        return "&aArtificial Crops &e[Nether Warts]";
	    }
