...
public class Artificial_Crops_Melon_2 extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Artificial_Crops_Melon_2() {
	        super(SPCItems.category_plant, SPCItems.ARTIFICIAL_CROPS_MELON_2, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	        		SPCItems.PROFESSIONAL_CIRCUIT_BOARD, SPCItems.NETHERITE_PLATE, SPCItems.PROFESSIONAL_CIRCUIT_BOARD,
	        		SPCItems.ENDERITE_INGOT, SPCItems.ARTIFICIAL_CROPS_MELON, SPCItems.ENDERITE_INGOT,
	   ...
	   protected void registerDefaultRecipes() {
	      ...
	      for (ItemStack itemlah : fertilizer) {
	    	  this.registerRecipe(8, new ItemStack[]{itemlah}, new ItemStack[]{new ItemStack(Material.MELON_SLICE, 9)});
	      }
	   ...
	   public String getMachineIdentifier() {
	      return "ARTIFICIAL_CROPS_MELON_2";
	   }
	   ...
	   @Override
	    ...
	    public String getInventoryTitle() {
	        return "&aArtificial Crops &e[Melon] &7- &eII";
	    }
