...
public class Artificial_Crops_Carrot extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Artificial_Crops_Carrot() {
	        super(SPCItems.category_plant, SPCItems.ARTIFICIAL_CROPS_CARROT, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	        		new ItemStack(Material.CARROT), SPCItems.ARTIFICIAL_HARVESTER, new ItemStack(Material.CARROT),
	   ...
	   public String getMachineIdentifier() {
	      return "ARTIFICIAL_CROPS_CARROT";
	   }
	   ...
	   @Override
	    ...
	    public String getInventoryTitle() {
	        return "&aArtificial Crops &e[Carrot]";
	    }
