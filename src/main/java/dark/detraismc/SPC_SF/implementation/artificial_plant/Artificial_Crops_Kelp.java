...
public class Artificial_Crops_Kelp extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Artificial_Crops_Kelp() {
	        super(SPCItems.category_plant, SPCItems.ARTIFICIAL_CROPS_KELP, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	        		new ItemStack(Material.KELP), SPCItems.ARTIFICIAL_HARVESTER, new ItemStack(Material.KELP),
	   ...
	   @Override
	    ...
	    public String getInventoryTitle() {
	        return "&aArtificial Crops &e[Kelp]";
	    }
