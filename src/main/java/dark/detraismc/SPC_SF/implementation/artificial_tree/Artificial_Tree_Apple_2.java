...
public class Artificial_Tree_Apple_2 extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Artificial_Tree_Apple_2() {
	        super(SPCItems.category_plant, SPCItems.ARTIFICIAL_TREE_APPLE_2, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	        		SPCItems.PROFESSIONAL_CIRCUIT_BOARD, SPCItems.NETHERITE_PLATE, SPCItems.PROFESSIONAL_CIRCUIT_BOARD,
	        		SPCItems.ENDERITE_INGOT, SPCItems.ARTIFICIAL_TREE_APPLE, SPCItems.ENDERITE_INGOT,
	        		SlimefunItems.POWER_CRYSTAL, SlimefunItems.TREE_GROWTH_ACCELERATOR, SlimefunItems.POWER_CRYSTAL
		    });
	    }

	   protected void registerDefaultRecipes() {
	      this.registerRecipe(8, new ItemStack[]{new ItemStack(Material.BONE_MEAL, 3)}, new ItemStack[]{new ItemStack(Material.APPLE, 2)});
	      this.registerRecipe(8, new ItemStack[]{new ItemStack(Material.OAK_SAPLING, 1)}, new ItemStack[]{new ItemStack(Material.APPLE, 4)});
	      this.registerRecipe(8, new ItemStack[]{new ItemStack(Material.DARK_OAK_SAPLING, 1)}, new ItemStack[]{new ItemStack(Material.APPLE, 4)});
	      ...
	      for (ItemStack itemlah : fertilizer) {
	    	  this.registerRecipe(8, new ItemStack[]{itemlah}, new ItemStack[]{new ItemStack(Material.APPLE, 2)});
	      }
	      ...
	      this.recipeList.add(new ItemStack(Material.APPLE, 4));
	   ...
	   public String getMachineIdentifier() {
	      return "ARTIFICIAL_TREE_APPLE_2";
	   }
	   ...
	   @Override
	    ...
	    public String getInventoryTitle() {
	        return "&aArtificial Tree &e[Apple] &7- &eII";
	    }
