...
public class Artificial_Tree_Oak extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Artificial_Tree_Oak() {
	        super(SPCItems.category_plant, SPCItems.ARTIFICIAL_TREE_OAK, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	        		new ItemStack(Material.OAK_SAPLING), SPCItems.ARTIFICIAL_HARVESTER, new ItemStack(Material.OAK_SAPLING),
	   ...
	   protected void registerDefaultRecipes() {
	      this.registerRecipe(5, new ItemStack[]{new ItemStack(Material.BONE_MEAL, 3)}, new ItemStack[]{new ItemStack(Material.OAK_LOG, 2), new ItemStack(Material.OAK_LEAVES, 3)});
	      this.registerRecipe(5, new ItemStack[]{new ItemStack(Material.OAK_SAPLING, 1)}, new ItemStack[]{new ItemStack(Material.OAK_LOG, 6), new ItemStack(Material.OAK_LEAVES, 9)});
	      ...
	      for (ItemStack itemlah : fertilizer) {
	    	  this.registerRecipe(5, new ItemStack[]{itemlah}, new ItemStack[]{new ItemStack(Material.OAK_LOG, 4), new ItemStack(Material.OAK_LEAVES, 6)});
	      }
	      
	      this.recipeList = new ArrayList<ItemStack>();
	      this.recipeList.add(new ItemStack(Material.BONE_MEAL, 3));
	      this.recipeList.add(new ItemStack(Material.OAK_LOG, 2));
	      ...
	      this.recipeList.add(new ItemStack(Material.OAK_LOG, 6));
	      this.recipeList.add(new ItemStack(Material.OAK_SAPLING));
	      this.recipeList.add(new ItemStack(Material.OAK_LEAVES, 9));
	      
	      for (ItemStack itemlah : fertilizer) {
	    	  this.recipeList.add(itemlah);
		      this.recipeList.add(new ItemStack(Material.OAK_LOG, 4));
		      this.recipeList.add(itemlah);
		      this.recipeList.add(new ItemStack(Material.OAK_LEAVES, 6));
		      }
