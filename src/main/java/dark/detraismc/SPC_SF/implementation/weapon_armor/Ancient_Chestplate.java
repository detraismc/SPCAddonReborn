...
public class Ancient_Chestplate extends SlimefunItem {

	  public Ancient_Chestplate() {
	    super(SPCItems.category_armor, SPCItems.ANCIENT_CHESTPLATE, RecipeType.ARMOR_FORGE, new ItemStack[] {
