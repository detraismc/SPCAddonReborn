...
public class Sniper_Rifle extends SlimefunItem {

	SPCAddon plugin = SPCAddon.getInstance();
	
	public Sniper_Rifle() {
		super(SPCItems.category_weapon, SPCItems.SNIPER_RIFLE, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
				SPCItems.ARTIFACT_CIRCUIT_BOARD, SPCItems.ARTIFACT_POWER_CORE, SPCItems.ARTIFACT_CIRCUIT_BOARD,
	    		SPCItems.TECH_COMPONENT, SPCItems.MUSKET, SPCItems.TECH_COMPONENT,
	    		SPCItems.ARTIFACT_CIRCUIT_BOARD, SPCItems.TECH_ARTIFACT, SPCItems.ARTIFACT_CIRCUIT_BOARD
		});
	}
	  ...
	  private void onItemRightClick(PlayerRightClickEvent event) {
		  ...
		  if (p.getInventory().getItemInOffHand().equals(SPCItems.SNIPER_RIFLE)) {
		  ...
		  ball.setVelocity(ball.getVelocity().multiply(20));
		  ball.setCustomName("Sniper Rifle");
