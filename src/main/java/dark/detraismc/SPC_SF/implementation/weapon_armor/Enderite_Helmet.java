...
public class Enderite_Helmet extends SlimefunItem {

	  public Enderite_Helmet() {
	    super(SPCItems.category_armor, SPCItems.ENDERITE_HELMET, RecipeType.ARMOR_FORGE, new ItemStack[] {
