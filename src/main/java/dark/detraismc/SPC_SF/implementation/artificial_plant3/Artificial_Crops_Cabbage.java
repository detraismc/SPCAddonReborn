...
public class Artificial_Crops_Cabbage extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Artificial_Crops_Cabbage() {
	        super(SPCItems.category_plant, SPCItems.ARTIFICIAL_CROPS_CABBAGE, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	        		SlimefunItem.getById("CABBAGE_BUSH").getItem(), SPCItems.ARTIFICIAL_HARVESTER, SlimefunItem.getById("CABBAGE_BUSH").getItem(),
	   ...
	   protected void registerDefaultRecipes() {
	      this.registerRecipe(10, new ItemStack[]{new ItemStack(Material.BONE_MEAL, 3)}, new ItemStack[]{SlimefunItem.getById("CABBAGE").getItem()});
	      ...
	      for (ItemStack itemlah : fertilizer) {
	    	  this.registerRecipe(10, new ItemStack[]{itemlah}, new ItemStack[]{SlimefunItem.getById("CABBAGE").getItem()});
	      }
	      
	      this.recipeList = new ArrayList<ItemStack>();
	      this.recipeList.add(new ItemStack(Material.BONE_MEAL, 3));
	      this.recipeList.add(SlimefunItem.getById("CABBAGE").getItem());
	   ...
	   public String getMachineIdentifier() {
	      return "ARTIFICIAL_CROPS_CABBAGE";
	   }
	   ...
	   @Override
	    ...
	    public ItemStack getProgressBar() {
	        return SlimefunItem.getById("CABBAGE").getItem();
	    }

	    @Override
	    public String getInventoryTitle() {
	        return "&aArtificial Crops &e[Cabbage]";
	    }
