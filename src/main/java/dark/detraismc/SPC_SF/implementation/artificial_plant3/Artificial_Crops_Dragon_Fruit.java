...
public class Artificial_Crops_Dragon_Fruit extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Artificial_Crops_Dragon_Fruit() {
	        super(SPCItems.category_plant, SPCItems.ARTIFICIAL_CROPS_DRAGON_FRUIT, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	        		SlimefunItem.getById("DRAGON_FRUIT_SAPLING").getItem(), SPCItems.ARTIFICIAL_HARVESTER, SlimefunItem.getById("DRAGON_FRUIT_SAPLING").getItem(),
	   ...
	   protected void registerDefaultRecipes() {
	      this.registerRecipe(10, new ItemStack[]{new ItemStack(Material.BONE_MEAL, 3)}, new ItemStack[]{SlimefunItem.getById("DRAGON_FRUIT").getItem()});
	      ...
	      for (ItemStack itemlah : fertilizer) {
	    	  this.registerRecipe(10, new ItemStack[]{itemlah}, new ItemStack[]{SlimefunItem.getById("DRAGON_FRUIT").getItem()});
	      }
	      
	      this.recipeList = new ArrayList<ItemStack>();
	      this.recipeList.add(new ItemStack(Material.BONE_MEAL, 3));
	      this.recipeList.add(SlimefunItem.getById("DRAGON_FRUIT").getItem());
	   ...
	   public String getMachineIdentifier() {
	      return "ARTIFICIAL_CROPS_DRAGON_FRUIT";
	   }
	   ...
	   @Override
	    ...
	    public ItemStack getProgressBar() {
	        return SlimefunItem.getById("DRAGON_FRUIT").getItem();
	    }

	    @Override
	    public String getInventoryTitle() {
	        return "&aArtificial Crops &e[Dragon Fruit]";
	    }
