...
public class Artificial_Crops_Blackberry extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Artificial_Crops_Blackberry() {
	        super(SPCItems.category_plant, SPCItems.ARTIFICIAL_CROPS_BLACKBERRY, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	        		SlimefunItem.getById("BLACKBERRY_BUSH").getItem(), SPCItems.ARTIFICIAL_HARVESTER, SlimefunItem.getById("BLACKBERRY_BUSH").getItem(),
	   ...
	   public String getMachineIdentifier() {
	      return "ARTIFICIAL_CROPS_BLACKBERRY";
	   }
	   ...
	   @Override
	    ...
	    public String getInventoryTitle() {
	        return "&aArtificial Crops &e[Blackberry]";
	    }
