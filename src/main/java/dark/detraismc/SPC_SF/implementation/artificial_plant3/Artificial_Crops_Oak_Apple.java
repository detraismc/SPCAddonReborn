...
public class Artificial_Crops_Oak_Apple extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Artificial_Crops_Oak_Apple() {
	        super(SPCItems.category_plant, SPCItems.ARTIFICIAL_CROPS_OAK_APPLE, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	        		SlimefunItem.getById("OAK_APPLE_SAPLING").getItem(), SPCItems.ARTIFICIAL_HARVESTER, SlimefunItem.getById("OAK_APPLE_SAPLING").getItem(),
	   ...
	   protected void registerDefaultRecipes() {
	      this.registerRecipe(10, new ItemStack[]{new ItemStack(Material.BONE_MEAL, 3)}, new ItemStack[]{SlimefunItem.getById("OAK_APPLE").getItem()});
	      ...
	      for (ItemStack itemlah : fertilizer) {
	    	  this.registerRecipe(10, new ItemStack[]{itemlah}, new ItemStack[]{SlimefunItem.getById("OAK_APPLE").getItem()});
	      }
	      
	      this.recipeList = new ArrayList<ItemStack>();
	      this.recipeList.add(new ItemStack(Material.BONE_MEAL, 3));
	      this.recipeList.add(SlimefunItem.getById("OAK_APPLE").getItem());
	   ...
	   public String getMachineIdentifier() {
	      return "ARTIFICIAL_CROPS_OAK_APPLE";
	   }
	   ...
	   @Override
	    ...
	    public ItemStack getProgressBar() {
	        return SlimefunItem.getById("OAK_APPLE").getItem();
	    }

	    @Override
	    public String getInventoryTitle() {
	        return "&aArtificial Crops &e[Oak Apple]";
	    }
