...
public class Artificial_Crops_Coconut extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Artificial_Crops_Coconut() {
	        super(SPCItems.category_plant, SPCItems.ARTIFICIAL_CROPS_COCONUT, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	        		SlimefunItem.getById("COCONUT_SAPLING").getItem(), SPCItems.ARTIFICIAL_HARVESTER, SlimefunItem.getById("COCONUT_SAPLING").getItem(),
	   ...
	   protected void registerDefaultRecipes() {
	      this.registerRecipe(10, new ItemStack[]{new ItemStack(Material.BONE_MEAL, 3)}, new ItemStack[]{SlimefunItem.getById("COCONUT").getItem()});
	      ...
	      for (ItemStack itemlah : fertilizer) {
	    	  this.registerRecipe(10, new ItemStack[]{itemlah}, new ItemStack[]{SlimefunItem.getById("COCONUT").getItem()});
	      }
	      
	      this.recipeList = new ArrayList<ItemStack>();
	      this.recipeList.add(new ItemStack(Material.BONE_MEAL, 3));
	      this.recipeList.add(SlimefunItem.getById("COCONUT").getItem());
	   ...
	   public String getMachineIdentifier() {
	      return "ARTIFICIAL_CROPS_COCONUT";
	   }
	   ...
	   @Override
	    ...
	    public ItemStack getProgressBar() {
	        return SlimefunItem.getById("COCONUT").getItem();
	    }

	    @Override
	    public String getInventoryTitle() {
	        return "&aArtificial Crops &e[Coconut]";
	    }
