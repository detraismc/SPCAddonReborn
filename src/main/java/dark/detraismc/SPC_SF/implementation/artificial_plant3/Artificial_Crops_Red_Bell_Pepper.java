...
public class Artificial_Crops_Red_Bell_Pepper extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Artificial_Crops_Red_Bell_Pepper() {
	        super(SPCItems.category_plant, SPCItems.ARTIFICIAL_CROPS_RED_BELL_PEPPER, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	        		SlimefunItem.getById("RED_BELL_PEPPER_BUSH").getItem(), SPCItems.ARTIFICIAL_HARVESTER, SlimefunItem.getById("RED_BELL_PEPPER_BUSH").getItem(),
	   ...
	   protected void registerDefaultRecipes() {
	      this.registerRecipe(10, new ItemStack[]{new ItemStack(Material.BONE_MEAL, 3)}, new ItemStack[]{SlimefunItem.getById("RED_BELL_PEPPER").getItem()});
	      ...
	      for (ItemStack itemlah : fertilizer) {
	    	  this.registerRecipe(10, new ItemStack[]{itemlah}, new ItemStack[]{SlimefunItem.getById("RED_BELL_PEPPER").getItem()});
	      }
	      
	      this.recipeList = new ArrayList<ItemStack>();
	      this.recipeList.add(new ItemStack(Material.BONE_MEAL, 3));
	      this.recipeList.add(SlimefunItem.getById("RED_BELL_PEPPER").getItem());
	   ...
	   public String getMachineIdentifier() {
	      return "ARTIFICIAL_CROPS_RED_BELL_PEPPER";
	   }
	   ...
	   @Override
	    ...
	    public ItemStack getProgressBar() {
	        return SlimefunItem.getById("RED_BELL_PEPPER").getItem();
	    }

	    @Override
	    public String getInventoryTitle() {
	        return "&aArtificial Crops &e[Red Bell Pepper]";
	    }
