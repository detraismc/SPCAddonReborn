...
public class Artificial_Crops_Cherry_2 extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Artificial_Crops_Cherry_2() {
	        super(SPCItems.category_plant, SPCItems.ARTIFICIAL_CROPS_CHERRY_2, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	        		SPCItems.PROFESSIONAL_CIRCUIT_BOARD, SPCItems.NETHERITE_PLATE, SPCItems.PROFESSIONAL_CIRCUIT_BOARD,
	        		SPCItems.ENDERITE_INGOT, SPCItems.ARTIFICIAL_CROPS_CHERRY, SPCItems.ENDERITE_INGOT,
	   ...
	   public String getMachineIdentifier() {
	      return "ARTIFICIAL_CROPS_CHERRY_2";
	   }
	   ...
	   @Override
	    ...
	    public String getInventoryTitle() {
	        return "&aArtificial Crops &e[Cherry] &7- &eII";
	    }
