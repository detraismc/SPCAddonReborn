...
public class Artificial_Crops_Cranberry_2 extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Artificial_Crops_Cranberry_2() {
	        super(SPCItems.category_plant, SPCItems.ARTIFICIAL_CROPS_CRANBERRY_2, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	        		SPCItems.PROFESSIONAL_CIRCUIT_BOARD, SPCItems.NETHERITE_PLATE, SPCItems.PROFESSIONAL_CIRCUIT_BOARD,
	        		SPCItems.ENDERITE_INGOT, SPCItems.ARTIFICIAL_CROPS_CRANBERRY, SPCItems.ENDERITE_INGOT,
	   ...
	   public String getMachineIdentifier() {
	      return "ARTIFICIAL_CROPS_CRANBERRY_2";
	   }
	   ...
	   @Override
	    ...
	    public String getInventoryTitle() {
	        return "&aArtificial Crops &e[Cranberry] &7- &eII";
	    }
