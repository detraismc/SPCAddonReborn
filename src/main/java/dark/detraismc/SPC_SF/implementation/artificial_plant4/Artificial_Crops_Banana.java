...
public class Artificial_Crops_Banana extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Artificial_Crops_Banana() {
	        super(SPCItems.category_plant, SPCItems.ARTIFICIAL_CROPS_BANANA, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	        		SPCItems.BANANA, SPCItems.ARTIFICIAL_HARVESTER, SPCItems.INDONESIAN_INGREDIENT_LOOTBAG,
	   ...
	   public String getMachineIdentifier() {
	      return "ARTIFICIAL_CROPS_BANANA";
	   }
	   ...
	   @Override
	    ...
	    public String getInventoryTitle() {
	        return "&aArtificial Crops &e[Banana]";
	    }
