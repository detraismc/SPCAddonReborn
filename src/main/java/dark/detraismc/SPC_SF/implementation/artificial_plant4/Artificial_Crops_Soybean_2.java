...
public class Artificial_Crops_Soybean_2 extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Artificial_Crops_Soybean_2() {
	        super(SPCItems.category_plant, SPCItems.ARTIFICIAL_CROPS_SOYBEAN_2, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	        		SPCItems.PROFESSIONAL_CIRCUIT_BOARD, SPCItems.NETHERITE_PLATE, SPCItems.PROFESSIONAL_CIRCUIT_BOARD,
	        		SPCItems.ENDERITE_INGOT, SPCItems.ARTIFICIAL_CROPS_SOYBEAN, SPCItems.ENDERITE_INGOT,
	        		SlimefunItems.POWER_CRYSTAL, SPCItems.CROPS_MOTOR, SlimefunItems.POWER_CRYSTAL
		    });
	    }

	   protected void registerDefaultRecipes() {
	      this.registerRecipe(12, new ItemStack[]{new ItemStack(Material.BONE_MEAL, 3)}, new ItemStack[]{SPCItems.SOYBEAN});
	      ...
	      for (ItemStack itemlah : fertilizer) {
	    	  this.registerRecipe(12, new ItemStack[]{itemlah}, new ItemStack[]{SPCItems.SOYBEAN});
	      }
	      
	      this.recipeList = new ArrayList<ItemStack>();
	      this.recipeList.add(new ItemStack(Material.BONE_MEAL, 3));
	      this.recipeList.add(SPCItems.SOYBEAN);
	   ...
	   public String getMachineIdentifier() {
	      return "ARTIFICIAL_CROPS_SOYBEAN_2";
	   }
	   ...
	   @Override
	    ...
	    public ItemStack getProgressBar() {
	        return SPCItems.SOYBEAN;
	    }

	    @Override
	    public String getInventoryTitle() {
	        return "&aArtificial Crops &e[Soybean] &7- &eII";
	    }
