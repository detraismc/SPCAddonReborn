...
public class Artificial_Crops_Coffee_Bean extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Artificial_Crops_Coffee_Bean() {
	        super(SPCItems.category_plant, SPCItems.ARTIFICIAL_CROPS_COFFEE_BEAN, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	        		SPCItems.COFFEE_BEAN, SPCItems.ARTIFICIAL_HARVESTER, SPCItems.INDONESIAN_INGREDIENT_LOOTBAG,
	   ...
	   public String getMachineIdentifier() {
	      return "ARTIFICIAL_CROPS_COFFEE_BEAN";
	   }
	   ...
	   @Override
	    ...
	    public String getInventoryTitle() {
	        return "&aArtificial Crops &e[Coffee Bean]";
	    }
