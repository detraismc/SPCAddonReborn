...
public class Artificial_Crops_Salam_And_Sereh extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Artificial_Crops_Salam_And_Sereh() {
	        super(SPCItems.category_plant, SPCItems.ARTIFICIAL_CROPS_SALAM_AND_SEREH, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	        		SPCItems.SALAM_AND_SEREH, SPCItems.ARTIFICIAL_HARVESTER, SPCItems.INDONESIAN_INGREDIENT_LOOTBAG,
	   ...
	   public String getMachineIdentifier() {
	      return "ARTIFICIAL_CROPS_SALAM_AND_SEREH";
	   }
	   ...
	   @Override
	    ...
	    public String getInventoryTitle() {
	        return "&aArtificial Crops &e[Salam And Sereh]";
	    }
