...
public class Artificial_Crops_Soybean extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Artificial_Crops_Soybean() {
	        super(SPCItems.category_plant, SPCItems.ARTIFICIAL_CROPS_SOYBEAN, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	        		SPCItems.SOYBEAN, SPCItems.ARTIFICIAL_HARVESTER, SPCItems.INDONESIAN_INGREDIENT_LOOTBAG,
	   ...
	   public String getMachineIdentifier() {
	      return "ARTIFICIAL_CROPS_SOYBEAN";
	   }
	   ...
	   @Override
	    ...
	    public String getInventoryTitle() {
	        return "&aArtificial Crops &e[Soybean]";
	    }
