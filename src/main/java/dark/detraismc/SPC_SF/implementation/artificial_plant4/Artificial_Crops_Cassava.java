...
public class Artificial_Crops_Cassava extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Artificial_Crops_Cassava() {
	        super(SPCItems.category_plant, SPCItems.ARTIFICIAL_CROPS_CASSAVA, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	        		SPCItems.CASSAVA, SPCItems.ARTIFICIAL_HARVESTER, SPCItems.INDONESIAN_INGREDIENT_LOOTBAG,
	   ...
	   public String getMachineIdentifier() {
	      return "ARTIFICIAL_CROPS_CASSAVA";
	   }
	   ...
	   @Override
	    ...
	    public String getInventoryTitle() {
	        return "&aArtificial Crops &e[Cassava]";
	    }
