...
public class Health_Potion_2 extends SlimefunItem {
	
	SPCAddon plugin = SPCAddon.getInstance();

	  public Health_Potion_2() {
	    super(SPCItems.category_consumable, SPCItems.HEALTH_POTION_2, SPCAddon_RecipeType.MINI_HOSPITAL, new ItemStack[] {
	    		SPCItems.HEALTH_POTION, SPCItems.HEALING_TICKET, null,
	    		null, null, null,
	    		null, null, null
	    });
	  }
