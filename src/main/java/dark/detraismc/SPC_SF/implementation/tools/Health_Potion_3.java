...
public class Health_Potion_3 extends SlimefunItem {
	
	SPCAddon plugin = SPCAddon.getInstance();

	  public Health_Potion_3() {
	    super(SPCItems.category_consumable, SPCItems.HEALTH_POTION_3, SPCAddon_RecipeType.MINI_HOSPITAL, new ItemStack[] {
	    		SPCItems.HEALTH_POTION_2, SPCItems.HEALING_CORE, null,
	    		null, null, null,
	    		null, null, null
	    });
	  }
