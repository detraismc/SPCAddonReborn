...
public class Cobbled_Deepslate_Generator extends SimpleSlimefunItem<BlockTicker> implements SPCInventoryBlock,
        EnergyNetComponent {
    ...
    public Cobbled_Deepslate_Generator() {
        super(SPCItems.category_machine, SPCItems.COBBLED_DEEPSLATE_GENERATOR, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
                SlimefunItems.PROGRAMMABLE_ANDROID_MINER, SlimefunItems.STEEL_INGOT, SlimefunItems.PROGRAMMABLE_ANDROID_MINER,
    ...
    public BlockTicker getItemHandler() {
        return new BlockTicker() {
            ...
            public void tick(Block b, SlimefunItem sf, Config data) {
                ...
                ItemStack output = new ItemStack(Material.COBBLED_DEEPSLATE);
