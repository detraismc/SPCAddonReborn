...
public class Mini_Hospital_3 extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Mini_Hospital_3() {
	        super(SPCItems.category_machine, SPCItems.MINI_HOSPITAL_3, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	        		SPCItems.BIFURCATING_COMPONENT, SlimefunItems.BLISTERING_INGOT_3, SPCItems.BIFURCATING_COMPONENT,
	        		SPCItems.WEEB_PLATE, SPCItems.MINI_HOSPITAL_2, SPCItems.WEEB_PLATE,
	        		SPCItems.VOID_INGOT, SlimefunItems.ENERGIZED_CAPACITOR, SPCItems.VOID_INGOT
		    });
	    }
