...
public class Artifact_Scanner_2 extends AContainer implements RecipeDisplayItem {
	
	SPCAddon plugin = SPCAddon.getInstance();

   public Artifact_Scanner_2() {
       super(SPCItems.category_machine, SPCItems.ARTIFACT_SCANNER_2, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
       		SPCItems.ARTIFACT_POWER_CORE, SPCItems.VOID_PLATE, SPCItems.ARTIFACT_POWER_CORE,
       		SPCItems.ARTIFACT_CIRCUIT_BOARD, SPCItems.ARTIFACT_SCANNER, SPCItems.ARTIFACT_CIRCUIT_BOARD,
	    		SPCItems.TECH_COMPONENT, SPCItems.NATURE_COMPONENT, SPCItems.ANCIENT_COMPONENT
	    });
   }
      ...
      if (!this.hasFreeSlot(menu)) {
         ...
         for(int var4 = 0; var4 < var3; ++var4) {
            ...
            if (SlimefunUtils.isItemSimilar(item, SPCItems.UNIDENTIFIED_ARTIFACT, true, false)) {
               ...
               recipe = new MachineRecipe(3 / this.getSpeed(), new ItemStack[]{SPCItems.UNIDENTIFIED_ARTIFACT}, new ItemStack[]{output});
...
private boolean hasFreeSlot(@Nonnull BlockMenu menu) {
   ...
   public String getInventoryTitle() {
       return "&1Artifact Scanner &7- &eII";
   }
