...
public class Corrupted_Table extends AContainer implements RecipeDisplayItem {
	
	private List<ItemStack> recipeList;
	
	   public Corrupted_Table() {
	        super(SPCItems.category_machine, SPCItems.CORRUPTED_TABLE, RecipeType.MAGIC_WORKBENCH, new ItemStack[] {
	        		new ItemStack(Material.NETHER_STAR), SlimefunItems.BLISTERING_INGOT_3, new ItemStack(Material.NETHER_STAR),
		    		SlimefunItems.BLISTERING_INGOT_3, new ItemStack(Material.ENCHANTING_TABLE), SlimefunItems.BLISTERING_INGOT_3,
