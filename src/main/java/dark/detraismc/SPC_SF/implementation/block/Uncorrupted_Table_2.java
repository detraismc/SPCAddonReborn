...
public class Uncorrupted_Table_2 extends AContainer implements RecipeDisplayItem {
	
	private List<ItemStack> recipeList;
	private List<ItemStack> recipess;
	
	   public Uncorrupted_Table_2() {
	        super(SPCItems.category_machine, SPCItems.UNCORRUPTED_TABLE_2, RecipeType.MAGIC_WORKBENCH, new ItemStack[] {
	        		SPCItems.NETHERITE_PLATE, SPCItems.ENDERITE_PLATE, SPCItems.NETHERITE_PLATE,
		    		SPCItems.CORRUPTED_DIAMOND, SPCItems.UNCORRUPTED_TABLE, SPCItems.CORRUPTED_DIAMOND,
	   ...
	   @Override
	    ...
	    public String getInventoryTitle() {
	        return "&eUncorrupted Table &7- &eII";
	    }
