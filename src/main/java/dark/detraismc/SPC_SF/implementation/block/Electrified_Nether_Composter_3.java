...
public class Electrified_Nether_Composter_3 extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Electrified_Nether_Composter_3() {
	        super(SPCItems.category_machine, SPCItems.ELECTRIFIED_NETHER_COMPOSTER_3, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	        		SPCItems.CORRUPTED_WARPED_STEM_2, SPCItems.CORRUPTED_NETHERITE_INGOT, SPCItems.CORRUPTED_CRIMSON_STEM_2,
	        		SPCItems.VOID_INGOT, SPCItems.ELECTRIFIED_NETHER_COMPOSTER_2, SPCItems.VOID_INGOT,
	        		SPCItems.CORRUPTED_NETHERITE_INGOT, SPCItems.DIRT_CREATOR_3, SPCItems.CORRUPTED_NETHERITE_INGOT
		    });
	    }
	   ...
	   public String getMachineIdentifier() {
	      return "ELECTRIFIED_NETHER_COMPOSTER_3";
	   }
	   ...
	   @Override
	    ...
	    public String getInventoryTitle() {
	        return "&cElectrified Nether Composter &7- &eIII";
	    }
