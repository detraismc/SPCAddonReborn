...
public class Alloy_Press extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Alloy_Press() {
	        super(SPCItems.category_machine, SPCItems.ALLOY_PRESS, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	        		new ItemStack(Material.PISTON), SPCItems.ELITE_INGOT, new ItemStack(Material.PISTON),
	        		SPCItems.SAPPHIRE_PLATE, SlimefunItems.ELECTRIC_PRESS_2, SPCItems.SAPPHIRE_PLATE,
