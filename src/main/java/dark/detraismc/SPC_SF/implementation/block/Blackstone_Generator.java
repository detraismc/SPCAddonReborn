...
public class Blackstone_Generator extends SimpleSlimefunItem<BlockTicker> implements SPCInventoryBlock,
        EnergyNetComponent {
    ...
    public Blackstone_Generator() {
        super(SPCItems.category_machine, SPCItems.BLACKSTONE_GENERATOR, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
                SlimefunItems.PROGRAMMABLE_ANDROID_MINER, SlimefunItems.REDSTONE_ALLOY, SlimefunItems.PROGRAMMABLE_ANDROID_MINER,
    ...
    public BlockTicker getItemHandler() {
        return new BlockTicker() {
            ...
            public void tick(Block b, SlimefunItem sf, Config data) {
                ...
                ItemStack output = new ItemStack(Material.BLACKSTONE);
