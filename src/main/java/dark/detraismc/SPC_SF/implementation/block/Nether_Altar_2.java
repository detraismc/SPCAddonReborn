...
public class Nether_Altar_2 extends AContainer implements RecipeDisplayItem {
	private List<ItemStack> recipeList;
	
	   public Nether_Altar_2() {
	        super(SPCItems.category_machine, SPCItems.NETHER_ALTAR_2, RecipeType.MAGIC_WORKBENCH, new ItemStack[] {
	        		SPCItems.PROFESSIONAL_CIRCUIT_BOARD, SPCItems.PROFESSIONAL_CIRCUIT_BOARD, SPCItems.PROFESSIONAL_CIRCUIT_BOARD,
	        		SPCItems.PROFESSIONAL_CIRCUIT_BOARD, SPCItems.NETHER_ALTAR, SPCItems.PROFESSIONAL_CIRCUIT_BOARD,
