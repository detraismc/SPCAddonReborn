...
public class Cirno_1 extends Freezer {

	  public Cirno_1() {
	    super(SPCItems.category_skin, SPCItems.CIRNO, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	    		new ItemStack(Material.SNOW_BLOCK), new ItemStack(Material.LILY_PAD), new ItemStack(Material.SNOW_BLOCK),
	    		new ItemStack(Material.LILY_PAD), SlimefunItems.FREEZER, new ItemStack(Material.LILY_PAD),
	    		new ItemStack(Material.SNOW_BLOCK), new ItemStack(Material.LILY_PAD), new ItemStack(Material.SNOW_BLOCK)
	    });
	  }
